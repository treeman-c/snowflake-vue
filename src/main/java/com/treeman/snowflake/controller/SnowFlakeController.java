...
public class SnowFlakeController {
    ...
    public List<Snowflake> getId() throws SeqException {
    ...
    public List<Snowflake> getList(@RequestParam(name = "id") String str){
    ...
    public List<Snowflake> deleteID(@RequestParam(name = "id") String str){
        String msg="";
        long id = Long.parseLong(str);
